...
def main(episode_num,dataset_dir,record_rate,if_multi):
    # dataset_dir = "/home/idlab504/VR_TELEOP/Datasets/new_pick_20hz_4thpart"
    ...
    if if_multi:
        for i in range(episode_num):
            ...
            save_videos(image_dict, 1/record_rate, video_path=os.path.join(dataset_dir, dataset_name + '_video.mp4'))
